...
export const command = {
    ...
    execute: async (interaction) => {
        ...
        const calmChannel = guild.channels.cache.get(CHANNEL_IDS.THE_CALM);
        const immigrationChannel = guild.channels.cache.get(CHANNEL_IDS.PRESENCE_IMMIGRATION_SYSTEM);
        ...
        try {
            ...
            const unassignedMembers = guild.members.cache.filter(member => !member.user.bot &&
            ...
            const clarityChannel = guild.channels.cache.get(CHANNEL_IDS.CLARITY_CHANNEL);
            const staticChannel = guild.channels.cache.get(CHANNEL_IDS.STATIC_CHANNEL);
...
//# sourceMappingURL=autosort.js.map