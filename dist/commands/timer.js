...
export const command = {
    ...
    execute: async (interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({ name: 'Days', value: `${days}`, inline: true }, { name: 'Hours', value: `${hours}`, inline: true }, { name: 'Minutes', value: `${minutes}`, inline: true }, { name: 'Seconds', value: `${seconds}`, inline: true })
            .setFooter({ text: 'The Presence Observes' })
            .setTimestamp();
        await interaction.editReply({ embeds: [embed] });
    },
