    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields({ name: 'User Query', value: userMessage, inline: false }, { name: 'Response', value: presenceResponse, inline: false })
            ...
            const errorEmbed = new EmbedBuilder()
                ...
                .setTitle('S.C.A.M')
                .setDescription('Signal Classification & Assignment Mechanism')
                .addFields({ name: 'Status', value: 'Signal interference detected. The Presence cannot be reached.' })
