...
async function scheduleCountdown(channel, eventTimeMs) {
                ...
                try {
                    if (interval.isCountdown) {
                        ...
                        const embed = new EmbedBuilder()
                            ...
                            .addFields({ name: '⚠️ Alert', value: 'The immigration phase has commenced. All unassigned members are now being classified and distributed.', inline: false })
